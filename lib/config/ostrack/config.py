...
cfg.TRAIN.MEMORY_MULTIPLIER = 1.0
...
cfg.TRAIN.MEMORY_FULL_CORRUPTION_NUM_FRAMES = 0
cfg.TRAIN.MEMORY_BLUR_KERNEL_SIZE = 19
cfg.TRAIN.MEMORY_BLUR_PASSES = 2
cfg.TRAIN.SEARCH_PER_FRAME_JITTER = True
cfg.TRAIN.ROLLOUT_CROP_JITTER = False
cfg.TRAIN.FREEZE_LAYERS = [0, ]
cfg.TRAIN.PRINT_INTERVAL = 50
cfg.TRAIN.VAL_EPOCH_INTERVAL = 20
cfg.TRAIN.GRAD_CLIP_NORM = 0.1
cfg.TRAIN.AMP = False
cfg.TRAIN.ROLLOUT_TEACHER_PROB_START = 1.0
cfg.TRAIN.ROLLOUT_TEACHER_PROB_END = 0.0
cfg.TRAIN.ROLLOUT_TEACHER_ANNEAL_EPOCHS = 20
...
cfg.MODEL.MEMORY.FILTER_REG = 1e-4
cfg.MODEL.MEMORY.FILTER_TARGET_ITERS = 6
cfg.MODEL.MEMORY.FILTER_MATCH_WEIGHT = 1.0
