...
\begin{document}
    ...
    metrics, achieving gains of +0.019 in AO, +0.019 in SR0.50, and +0.011 in SR0.75. Because only one final configuration was
    ...
    However, the results remain below those of OSTrack-384 + CE. This indicates that while the memory-augmented 256-resolution model closes the gap to the stronger
