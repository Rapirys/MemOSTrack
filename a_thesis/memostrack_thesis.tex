...
tracking [1], optical flow-based methods [2][16] , particle filters [3], and template
...
online, instead of relying only on a static initial template.
DiMP-style trackers are architecturally different from the standard siamese and show that
