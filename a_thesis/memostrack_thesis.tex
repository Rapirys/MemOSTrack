...
\begin{document}
    ...
    \begin{figure}[htbp]
        ...
        \caption{Vision Transformer architecture. Vision Transformer.svg by Zhang, Lipton, Li, and Smola, licensed under CC BY-SA 4.0, via Wikimedia Commons \cite{zhang2024vitfigure}.}
        \label{fig:vit}
    \end{figure}
    ...
    same-resolution OSTrack-256 + CE baseline, while remaining below the stronger
    high-resolution OSTrack-384 + CE baseline. These results suggest that the complete
    MemOSTrack pipeline is a promising extension of OSTrack, but they do not isolate the
