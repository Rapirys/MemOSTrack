...
online, instead of relying only on a static initial template. The later PrDiMP [16]
...
because transformer-style attention is quadratic in the number of tokens {[}18{]}. For
...
address this is Truncated Backpropagation Through Time {[}23{]}. In the provided implementation, the model periodically
...
labeled bounding boxes {[}17{]}. The test annotations are hidden, and evaluation is
...
recurrent parameters are trained together with a pretrained transformer backbone {[}24{]}.
...
[16] M. Danelljan, L. Van Gool, and R. Timofte, `Probabilistic Regression for Visual
Tracking,' CVPR, 2020.
...
[23] R. J. Williams and D. Zipser, `Gradient-Based Learning Algorithms for Recurrent
Networks and Their Computational Complexity,' in Backpropagation: Theory, Architectures,
and Applications, 1995.

[24] R. Pascanu, T. Mikolov, and Y. Bengio, `On the Difficulty of Training Recurrent
